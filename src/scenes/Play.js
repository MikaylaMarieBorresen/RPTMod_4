class Play extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('explosion2', './assets/explosionbat2.png', {frameWidth: 47, frameHeight: 28, startFrame: 0, endFrame: 6});
        this.load.spritesheet('bat1anim', './assets/bat1flying.png', {frameWidth: 64, frameHeight: 32, startFrame: 0, endFrame: 2});
        this.load.spritesheet('bat2anim', './assets/bat2flying.png', {frameWidth: 47, frameHeight: 28, startFrame: 0, endFrame: 2});
    }
    ...
    create() {
        ...
        this.ship04 = new Spaceship2(this, game.config.width + borderUISize*6, borderUISize*4, 'spaceship2', 0, 40).setOrigin(0, 0);
        ...
        this.anims.create({
            key: 'explode2',
            frames: this.anims.generateFrameNumbers('explosion2', { start: 0, end: 6, first: 0}),
            frameRate: 30
        });
